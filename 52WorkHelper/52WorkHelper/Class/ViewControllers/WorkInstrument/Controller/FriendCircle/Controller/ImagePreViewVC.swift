...
//  52WorkHelper
//
//  Created by chenqihang on 2018/8/1.
...
UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView,
        ...
        -> UICollectionViewCell {
            ...
            cell.imageView.sd_setImage(with: URL(string: self.images[indexPath.row] ), placeholderImage:UIImage.init(named: "CQIndexPersonDefault"))
            return cell
    }
