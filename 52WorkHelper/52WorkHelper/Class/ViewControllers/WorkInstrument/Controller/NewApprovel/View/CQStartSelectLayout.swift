...
class CQStartSelectLayout: TGLinearLayout {
    ...
    convenience init(orientation: TGOrientation,name:String,type:String,title:String,prompt:String,require:Bool,startTime:String) {
        self.init(frame: CGRect.zero, orientation: orientation, name: name, type: type, title: title, prompt: prompt, require: require,startTime:startTime)
        
    }
    
    init(frame: CGRect, orientation: TGOrientation,name:String,type:String,title:String,prompt:String,require:Bool,startTime:String) {
    ...
    func initView()  {
        ...
        if !self.startTime.isEmpty{
            self.addSubview(self.addSelectBtn(title: self.startTime))
        }else{
