...
class CQCopyPersonLayout: TGLinearLayout {
    ...
    var dataArray = [NCQApprovelDetailModel]() //抄送人列表
    ...
    func initView()  {
        ...
        self.collectionHeight = CGFloat(self.dataArray.count/4 + 1) * AutoGetHeight(height: 75) + AutoGetHeight(height: 50)
...
extension CQCopyPersonLayout: UICollectionViewDataSource {
...
extension CQCopyPersonLayout: UICollectionViewDelegate {
