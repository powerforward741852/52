...
class CQModeifyTimeLayout: TGLinearLayout {
    ...
    @objc func sureClick() {
        ...
        NotificationCenter.default.post(name: NSNotification.Name.init("ModifyTimeValue"), object: self.modelArray[(pickView?.selectedRow(inComponent: 0))!])
...
//pick代理
extension CQModeifyTimeLayout:UIPickerViewDelegate,UIPickerViewDataSource{
