...
class CQEndSelectLayout: TGLinearLayout {
    ...
    convenience init(orientation: TGOrientation,name:String,type:String,title:String,prompt:String,require:Bool,endTime:String) {
        self.init(frame: CGRect.zero, orientation: orientation, name: name, type: type, title: title, prompt: prompt, require: require,endTime:endTime)
        
    }
    
    init(frame: CGRect, orientation: TGOrientation,name:String,type:String,title:String,prompt:String,require:Bool,endTime:String) {
    ...
    func initView()  {
        ...
        if !self.endTime.isEmpty{
            self.addSubview(self.addSelectBtn(title: self.endTime))
        }else{
    ...
    @objc func sureClick() {
        ...
        NotificationCenter.default.post(name: NSNotification.Name.init("endTimeValue"), object: endTime)
