...
class CQFromCityLayout: TGLinearLayout {
    ...
    convenience init(orientation: TGOrientation,name:String,type:String,title:String,prompt:String,require:Bool,dataFormat:String) {
        self.init(frame: CGRect.zero, orientation: orientation, name: name, type: type, title: title, prompt: prompt, require: require,dataFormat:dataFormat)
        
    }
    
    init(frame: CGRect, orientation: TGOrientation,name:String,type:String,title:String,prompt:String,require:Bool,dataFormat:String) {
    ...
    @objc func sureClick() {
        ...
        NotificationCenter.default.post(name: NSNotification.Name.init("fromCityValue"), object: self.curSelectTitle)
...
//pick代理
extension CQFromCityLayout:UIPickerViewDelegate,UIPickerViewDataSource{
