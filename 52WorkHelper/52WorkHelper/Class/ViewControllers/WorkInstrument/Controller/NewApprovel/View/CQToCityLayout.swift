...
class CQToCityLayout: TGLinearLayout {
    ...
    @objc func sureClick() {
        ...
        NotificationCenter.default.post(name: NSNotification.Name.init("toCityValue"), object: self.curSelectTitle)
...
//pick代理
extension CQToCityLayout:UIPickerViewDelegate,UIPickerViewDataSource{
