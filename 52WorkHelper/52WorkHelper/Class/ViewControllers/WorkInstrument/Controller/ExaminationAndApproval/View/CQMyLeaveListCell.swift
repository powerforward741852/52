...
class CQMyLeaveListCell: UITableViewCell {
...
//        self.bgView.layer.borderWidth =  1
    ...
    var model: CQMyLeaveListModel? {
        didSet {
            self.leaveTypeLab.text = model?.text
            self.leaveTypeLab.adjustsFontSizeToFitWidth = true
            var unitStr = ""
            ...
            self.restLab.text = "剩余" + (model?.balanceNumber)! + unitStr
