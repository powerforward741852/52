...
@implementation XJWaterFallLayout
#pragma mark---- 懒加载 ----
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.itemHeightBlock) itemHeight = self.itemHeightBlock(itemWidth, indexPath);
        ...
        if ([self.water_delegate respondsToSelector:@selector(waterfallLayout:itemHeightForWidth:atIndexPath:)])
            itemHeight = [self.water_delegate waterfallLayout:self itemHeightForWidth:itemWidth atIndexPath:indexPath];
    }
