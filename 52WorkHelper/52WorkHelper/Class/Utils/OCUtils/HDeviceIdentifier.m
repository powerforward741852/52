...
+(BOOL)syncDeviceIdentifier{
    ...
    BOOL f = [SFHFKeychainUtils storeUsername:@"52WorkHelperDeviceIdentifier" andPassword:myUUIDStr forServiceName:bundleIdentifier updateExisting:NO error:nil];
...
+(NSString*)deviceIdentifier{
    ...
    //从钥匙串中获取唯一设备标识
    NSString * deviceIdentifier = [SFHFKeychainUtils getPasswordForUsername:@"52WorkHelperDeviceIdentifier" andServiceName:bundleIdentifier error:nil];
